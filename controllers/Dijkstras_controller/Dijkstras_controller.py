...
class Dijkstras:
    ...
    def path_maker(self):
        ...
        #We keep going until we are at coordinate 0,0 on the graph
        while self.board[self.position_y-1][self.position_x] != 1 and self.board[self.position_y][self.position_x-1] != 1  and self.position_x != 0:
            self.mark_point()
    ...
    # We mark the path based on which next coordinate is cheaper, the left or above   
    def mark_point(self):
